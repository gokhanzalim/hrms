...
public class JDFKPSPublicSoap
{
    ...
    public JDFKPSPublicSoap(){}

    public JDFKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public JDFKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        JDFExtendedSoapSerializationEnvelope envelope= new JDFExtendedSoapSerializationEnvelope(JDFExtendedSoapSerializationEnvelope.VER11);
