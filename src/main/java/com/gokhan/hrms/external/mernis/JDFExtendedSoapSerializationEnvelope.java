...
public class JDFExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(JDFDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new JDFStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static JDFDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static JDFDateTimeConverter dateTimeConverter = new JDFStandardDateTimeConverter();

    public JDFExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public JDFExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new JDFMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=JDFHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,JDFExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=JDFHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
